...
class HeapSortTest {
    ...
    private String[] algorithms = {"heap"};
    ...
    public void testDescending(){
        ...
        System.out.println(Arrays.toString(app.getResult()));
        assertArrayEquals(output, app.getResult());
    }
    ...
    public void testOneIterationAsc() {
        Integer[] input = new Integer[]{32, 43, 12, 53, 3, 9, 1, 0, 10, 4};
        Integer[] output = new Integer[]{3, 43, 12, 32, 4, 9, 1, 0, 10, 53};
    ...
    * Test for 1 iteration in descending mode
    ...
    public void testOneIterationDesc() {
        Integer[] input = new Integer[]{32, 43, 12, 53, 3, 9, 1, 0, 10, 4};
        Integer[] output = new Integer[]{32, 3, 1, 10, 4, 9, 12, 53, 43, 0};
