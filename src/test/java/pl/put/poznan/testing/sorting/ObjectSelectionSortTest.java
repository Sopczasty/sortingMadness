...
class ObjectSelectionSortTest {
    ...
    public void testAscending1(){
        ...
        output.add(s5);
        output.add(s6);
        assertArrayEquals(output.toArray(), app.getResult(input, "selection", "asc", "name").toArray());
    }
    ...
    public void testDescending1(){
        ...
        output.add(s1);
        output.add(s8);
        assertArrayEquals(output.toArray(), app.getResult(input, "selection", "desc", "name").toArray());
    }
    ...
    public void testAscending2(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "selection", "asc", "time").toArray());
    }
    ...
    public void testDescending2(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "selection", "desc", "time").toArray());
    }
    ...
    public void testAscending3(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "selection", "asc", "size").toArray());
    }
    ...
    public void testDescending3() {
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "selection", "desc", "size").toArray());
    }
    ...
    public void testIncorrectInput(){
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            app.getResult(input, "selection", "asc", "name").toArray();
        });
    ...
    public void testIncorrectDirection(){
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            app.getResult(input, "selection", "error", "name").toArray();
        });
    ...
    public void tetsIncorectParammeter(){
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> app.getResult(input, "selection", "asc", "price").toArray());
