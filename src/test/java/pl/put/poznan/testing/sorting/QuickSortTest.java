...
//        // FIXME: calling app.getResult() directly fails this test, but putting it into a variable lets the test pass
//        int[] test_out = app.getResult();
//        assertArrayEquals(output, test_out);
//    }
//
