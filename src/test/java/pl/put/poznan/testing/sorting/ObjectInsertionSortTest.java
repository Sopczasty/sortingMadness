...
class ObjectInsertionSortTest {
    ...
    public void testAscending1(){
        ...
        output.add(s5);
        output.add(s6);
        assertArrayEquals(output.toArray(), app.getResult(input, "insertion", "asc", "name").toArray());
    }
    ...
    public void testDescending1(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "insertion", "desc", "name").toArray());
    }
    ...
    public void testAscending2(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "insertion", "asc", "time").toArray());
    }
    ...
    public void testDescending2(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "insertion", "desc", "time").toArray());
    }
    ...
    public void testAscending3(){
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "insertion", "asc", "size").toArray());
    }
    ...
    public void testDescending3() {
        ...
        assertArrayEquals(output.toArray(), app.getResult(input, "insertion", "desc", "size").toArray());
    }
    ...
    public void testIncorrectInput(){
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            app.getResult(input, "insertion", "asc", "name").toArray();
        });
    ...
    public void testIncorrectDirection(){
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            app.getResult(input, "insertion", "error", "name").toArray();
        });
    ...
    public void tetsIncorectParammeter(){
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> app.getResult(input, "insertion", "asc", "price").toArray());
